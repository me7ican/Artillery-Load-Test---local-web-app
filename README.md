...
**Interpretation:** Under peak load, 95% of requests completed within ~62ms and 99% within ~93ms, indicating stable latency for localhost conditions.
...
**Note:** 303 redirects are typical for authentication flows (redirect-after-login). If redirects are enabled in the HTTP client, extra follow-up requests may increase total request count and affect “requests per URL” interpretation.
